    ...
    <div class="px-5 py-5 p-lg-0 bg-surface-secondary">
        <div class="d-flex justify-content-center">
            <div class="side-hero col-lg-5 col-xl-4 p-12 p-xl-20 position-fixed start-0 top-0 h-screen overflow-y-hidden bg-primary d-none d-lg-flex flex-column">
                ...
                <!-- Title -->
                <div class="mt-32 mb-20 shadow glassmorph p-4">
                    <h1 class="ls-tight font-bolder display-6  mb-5">
                        Login With Your Account Now
                    </h1>
                    <p class="text-dark fw-bold">
                       If you Not Have An Account, Please Register First Before Login
                    </p>
                </div>
                <!-- Circle -->
                ...
                <div class="row">
                    <div class="col-lg-10 col-md-9 col-xl-6 mx-auto ms-xl-0">
                        ...
                        <div class="my-6">
                            ...
                            <a href="{{ route('register') }}" class="text-success text-sm font-semibold">{{ __('Sign up') }}</a>
                        </div>
                    </div>
                </div>
            </div>
