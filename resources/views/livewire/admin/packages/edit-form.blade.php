<div class="row align-items-center">
    <div class="col-md-6">
        <div class="card mt-3">
            <div class="card-body mt-3">
                <form wire:submit.prevent="update()" id="formUpdate">
                    <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                        <label for="inputText" required class="col-12 col-form-label">Price <span
                                class="text-danger">*</span></label>
                        <div class="col-12">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-11">
                            <input type="text" class=" @error('feauture_name.0') is-invalid @enderror form-control"
                        ...
                        <div class="col-1 text-center">
                            <button class="btn btn-success" type="button"
                                wire:click.prevent="add({{ $i }})"><i class="bi bi-plus"></i></button>
                        </div>
                    </div>
    ...
    <div class="col-md-6">
        <div class="card mt-3">
            <div class="card-body mt-3">
                <p class="fw-bold">Package Feauture</p>
                <hr>
                @livewire('admin.packages.feautures.feauture-table', ['package' => $package])
    ...
    @push('scripts')
        <script>
            document.addEventListener('refreshTable', event => {
                Livewire.components.getComponentsByName('admin.packages.feautures.feauture-table')[0].$wire.$refresh()
            });
        </script>
    @endpush
