        ...
        <section class="section">
            <div class="row align-items-center">
                    ...
                    <div class="card mt-3">
                        <div class="card-body">
                            ...
                            <form enctype="multipart/form-data" method="POST"
                                action="{{ Route('admin.events.update',['event'=>$event->id]) }}" class="p-3">
                                @method("patch")
                                @csrf
                                <div class="row mb-3">
                                    ...
                                    <div class="col-12">
                                        <input type="text" class=" @error('name') is-invalid @enderror form-control"
                                            placeholder="Input Event Name" name="name" value="{{ $event->name }}">
                                        @error('name')
                ...
                <div class="col-lg-3 col-12">
                    ...
                    <div class="imgPreview card  mx-auto" id="contentImg" style="background-image: url({{ $event->thumbnail }})">
                    </div>
